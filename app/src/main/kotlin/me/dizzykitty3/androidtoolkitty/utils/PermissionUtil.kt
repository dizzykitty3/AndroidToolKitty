...
object PermissionUtil {
    ...
    fun noBluetoothPermission(context: Context): Boolean {
        return if (OSVersion.android12()) check(context, BT_CONNECT)
    ...
    private fun request(context: Context, permission: Array<String>) = ActivityCompat.requestPermissions(context as Activity, permission, 1)
}